...
**Версия:** 2.3
**Последнее обновление:** 2026-05-22 (вечер)
...
- [x] `content(additional): v2.0 — 7 кружков (фикс-сетка 3×3), новые педагоги, обновлённые цены`
- [x] `content(team): v2.0 — 5 featured cards (2×3 grid), Галан → завуч, +Комкова, цитаты`
- [x] `content(school-life): v2.0 — «Атмосфера школы», переименование фото, актуализация caption`
- [x] `content(enrollment): v2.0 — 4 шага, диагностика, список документов`
- [x] `content(faq): v2.0 — 7 вопросов, удалён про лицензию до подтверждения`
- [x] `content(header-footer-contacts-site): v2.0 — «Лагерь» → «Лето», +VK в contacts, очистка site.ts`
...
- [x] Обновить контент-коллекцию `team` (5 featured + добавлена Комкова, цитаты)
- [x] Расширить `SocialIcons` — добавить VK в режим `contacts` (3 иконки вместо 2)
